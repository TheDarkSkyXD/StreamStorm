...
export const KickChat: React.FC<KickChatProps> = ({
    ...
    useEffect(() => {
        ...
        const connect = async () => {
            try {
                ...
                const isChannelChanged = !currentChannelRef.current ||
    ...
    }, [channel, chatroomId, clearMessages, loadGlobalEmotes, loadChannelEmotes, setActiveChannel, unloadChannelEmotes, addMessage]);
