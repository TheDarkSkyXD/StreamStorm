      ...
      <div className='w-[280px] flex-shrink-0 flex flex-col border-r border-[#27272a] bg-[#121214]'>
        ...
        <div className='flex-1 overflow-y-auto py-2 px-3 space-y-6'>
          ...
          <div className='space-y-1'>
            <h3 className='px-3 text-[10px] font-bold text-zinc-500 uppercase tracking-widest mb-2 mt-4'>App Settings</h3>
        ...
        <div className='max-w-4xl p-8 py-10'>
            ...
            <div className='space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300'>
              ...
              <div className='p-6 rounded-xl border border-[#27272a] bg-[#121214]'>
                ...
                <div className="mt-4 p-4 rounded-lg bg-blue-500/5 border border-blue-500/10 text-sm text-blue-300/80 leading-relaxed">
                  ...
                  It works without external proxies. A shield icon will appear in the player when active.
                </div>
              </div>
            </div>
          )}
          ...
          {activeTab === 'integrations' && (
            <div className='space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300'>
              ...
              {error && (
                <div className={`flex items-start gap-4 p-4 rounded-xl border mb-6 ${error.platform === 'twitch'
  ...
  return (
    ...
    >
      <div className={cn(
        ...
        isActive ? "bg-[#18181b] text-white" : "bg-[#18181b] text-zinc-500 group-hover:text-zinc-300 group-hover:bg-[#3f3f46]"
      )}>
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className={cn("text-[11px] truncate mt-0.5", isActive ? "text-zinc-300" : "text-zinc-600 group-hover:text-zinc-500")}>
          {description}
        </p>
      </div>
    </button>
