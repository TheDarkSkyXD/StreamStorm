...
import { UnifiedChannel, UnifiedCategory, UnifiedStream, UnifiedVideo, UnifiedClip } from '../../backend/api/unified/platform-types';

export const SEARCH_KEYS = {
    all: ['search'] as const,
    channels: (query: string, platform?: Platform) => [...SEARCH_KEYS.all, 'channels', query, platform] as const,
    categories: (query: string, platform?: Platform) => [...SEARCH_KEYS.all, 'categories', query, platform] as const,
    everything: (query: string, platform?: Platform) => [...SEARCH_KEYS.all, 'everything', query, platform] as const,
};
