...
description: Generates high-quality, predictable, and efficient .agent/skills/ directories based on user requirements. Includes standards for structure, frontmatter, and writing principles.
---
