      ...
      <div className="flex-1 flex flex-col overflow-y-auto">
        ...
        <div className="p-4 border-b border-[var(--color-border)]">
          <Link
            ...
            search={{ tab: "videos" }}
            className="text-sm text-[var(--color-foreground-muted)] hover:text-white flex items-center gap-2"
          >
          ...
          <div className="w-full md:w-[350px] shrink-0 flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-center gap-3">
                ...
                >
                  <div
                    className={`w-16 h-16 rounded-full flex items-center justify-center text-2xl font-bold text-white shadow-lg ${platform === "twitch" ? "bg-[#9146FF]" : "bg-[#53FC18] text-black"} ring-2 ring-offset-2 ring-offset-[var(--color-background)] ${platform === "twitch" ? "ring-[#9146FF]" : "ring-[#53FC18]"}`}
                  >
      ...
      <div className="w-80 border-l border-[var(--color-border)] bg-[var(--color-background-secondary)] flex flex-col shrink-0 hidden lg:flex">
        ...
        <div className="flex-1 p-3 flex items-center justify-center">
          <p className="text-[var(--color-foreground-muted)] text-sm text-center">
            Chat replay not available for this clip
          </p>
        </div>
      </div>
    </div>
