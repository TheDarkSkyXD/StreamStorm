    ...
    <div className="p-6 max-w-5xl mx-auto space-y-8">
      ...
      <section className="space-y-4">
        ...
        {activeDownloads.length === 0 ? (
          <div className="text-[var(--color-foreground-secondary)] italic">
            No active downloads.
          </div>
        ) : (
              ...
              >
                  ...
                  <div className="flex justify-between mb-1">
                    ...
                    <div className="text-xs text-[var(--color-foreground-secondary)] font-mono whitespace-nowrap">
                      {item.status === "downloading" ? (
                        <>
                          <span className="text-[var(--color-primary)]">{item.speed}</span> •{" "}
                          {item.timeLeft}
                        </>
                      ) : (
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    size="icon"
                    variant="ghost"
                    className="h-8 w-8 hover:text-red-500 hover:bg-zinc-800"
                  >
